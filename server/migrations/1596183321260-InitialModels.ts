...
export class InitialModels1596183321260 implements MigrationInterface {
    name = 'InitialModels1596183321260'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "zip_code" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "countryId" uuid, "stateId" uuid, "cityId" uuid, CONSTRAINT "REL_4c935ec36e6e8d3af3c8ae3590" UNIQUE ("countryId"), CONSTRAINT "REL_905cfb30a9599192a4ab4c9443" UNIQUE ("stateId"), CONSTRAINT "REL_5bbe448e83da2b8be184663863" UNIQUE ("cityId"), CONSTRAINT "PK_23e29929d32a535be7820652aad" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "address" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "street" character varying(96) NOT NULL, "type" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "zipCodeId" uuid, CONSTRAINT "REL_5614fb41e9fe1e998f6b1de6d0" UNIQUE ("zipCodeId"), CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "property" ADD CONSTRAINT "FK_9cc442b095b320686e85d689f10" FOREIGN KEY ("favouriteId") REFERENCES "user_favourite"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "property" DROP CONSTRAINT "FK_9cc442b095b320686e85d689f10"`);
